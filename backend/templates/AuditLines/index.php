        ...
        <table>
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td><?= $auditLine->hasValue('replenishment') ? $this->Html->link($auditLine->replenishment->replenishment_number, ['controller' => 'Replenishments', 'action' => 'view', $auditLine->replenishment->id]) : '' ?></td>
